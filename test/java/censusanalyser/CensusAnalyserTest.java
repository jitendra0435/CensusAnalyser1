...
public class CensusAnalyserTest {
    ...
    public void givenIndianCensusCSVFileReturnsCorrectRecords() {
        try {
            ...
            int numOfRecords = indiaCensusAdapter.loadCensusData(CensusAnalyser.Country.INIDIA,INDIA_CENSUS_CSV_FILE_PATH,INDIAN_STATE_CSV_PATH);
    ...
    public void givenIndiaCensusData_WithWrongFile_ShouldThrowException() {
        try {
            ...
            indiaCensusAdapter.loadCensusData(CensusAnalyser.Country.INIDIA,WRONG_CSV_FILE_PATH);
        } catch (CensusAnalyserException e) {
    ...
    public void givenIndianSateCSV_ShouldReturnExactCount() {
        try {
            CensusAnalyser indiaCensusAdapter = new CensusAnalyser();
            int numOfStateCode = indiaCensusAdapter.loadCensusData(CensusAnalyser.Country.INIDIA,INDIAN_STATE_CSV_PATH);
    ...
    public void givenIndianStateCodeCSVFile_withWrongFile_ShouldThrowException() {
        try {
            ...
            ExpectedException exceptionRule = ExpectedException.none();
            exceptionRule.expect(CensusAnalyserException.class);
            indiaCensusAdapter.loadCensusData(CensusAnalyser.Country.INIDIA,INDIAN_WRONG_CSV_FILE_PATH);
        } catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.ExceptionType.CENSUS_FILE_PROBLEM, e.type);
        }
    }
    ...
    public void givenIndianCencusData_whenContainInCorrectHeader() {
        try {
            CensusAnalyser indiaCensusAdapter = new CensusAnalyser();
            indiaCensusAdapter.loadCensusData(CensusAnalyser.Country.INIDIA,INDIAN_STATECODE_CSV_PATH_DUMMY);
        } catch (CensusAnalyserException e) {
    ...
    public void givenIndianStateCodeCSVfile_whenContainInCorrectHeader() {
        try {
            CensusAnalyser indiaCensusAdapter = new CensusAnalyser();
            indiaCensusAdapter.loadCensusData(CensusAnalyser.Country.INIDIA,INDIAN_STATE_CSV_PATH_DUMMY);
        } catch (CensusAnalyserException e) {
            Assert.assertEquals(CensusAnalyserException.ExceptionType.ERROR_WHILE_LOADING, e.type);
        }
    }
